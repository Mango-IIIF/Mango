...
const story: StoryWithDefaults = {
  ...
  chapters: [
    ...
    },
    {
      ...
      manifest: 'm2',
      canvasIndex: 0,
      model: { cameraOrbit: '1rad', cameraTarget: '0 0 0', orientation: '45deg' },
      transitionTimeMs: 2000,
    },
  ],
};
...
describe('storyViewerController.loadChapter', () => {
  it('applies viewBox, media seek, and model pose', async () => {
    ...
    expect(viewer.setModelPose).toHaveBeenCalled();
  ...
  it('auto advances silent chapters after transitionTimeMs', async () => {
    ...
    const silentStory: StoryWithDefaults = {
      ...
      type: 'story',
      chapters: [
        { id: 's1', manifest: 'm1', canvasIndex: 0, viewBox: { x: 0, y: 0, w: 10, h: 10 }, transitionTimeMs: 200 },
        { id: 's2', manifest: 'm1', canvasIndex: 1, viewBox: { x: 0, y: 0, w: 10, h: 10 }, transitionTimeMs: 200 },
      ],
    };
  ...
  it('chapter click stops media playback and stays idle', async () => {
    ...
    const mediaStory: StoryWithDefaults = {
      ...
      type: 'story',
      chapters: [
        { id: 'm1', manifest: 'm1', canvasIndex: 0, media: { start: 0, end: 2 }, transitionTimeMs: 100 },
        { id: 'm2', manifest: 'm1', canvasIndex: 1, media: { start: 0, end: 2 }, transitionTimeMs: 100 },
      ],
    };
  ...
  it('sets ENDED at story end and play restarts last chapter', async () => {
    ...
    const silentOneChapter: StoryWithDefaults = {
      ...
      type: 'story',
      chapters: [
        { id: 'last', manifest: 'm1', canvasIndex: 0, viewBox: { x: 0, y: 0, w: 10, h: 10 }, transitionTimeMs: 100 },
      ],
    };
  ...
  it('waits for manifestChange and pageChange events before applying viewBox', async () => {
    ...
    const storyWithManifestChange: StoryWithDefaults = {
      ...
      type: 'story',
      chapters: [
        { id: 'c1', manifest: 'm1', canvasIndex: 0, viewBox: { x: 0, y: 0, w: 100, h: 100 }, transitionTimeMs: 100 },
        { id: 'c2', manifest: 'm2', canvasIndex: 0, viewBox: { x: 10, y: 10, w: 50, h: 50 }, transitionTimeMs: 100 },
        { id: 'c3', manifest: 'm2', canvasIndex: 1, viewBox: { x: 20, y: 20, w: 30, h: 30 }, transitionTimeMs: 100 },
      ],
    };
